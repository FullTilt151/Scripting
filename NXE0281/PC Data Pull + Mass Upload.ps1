function Show-PullPCData_psf {
	...
	$MainFrm_Load={
		...
		Write-Host "!!!Application must be ran using A account!!!"
		Write-Host "!!!SQL Management Studio must be installed!!!"
        Write-Host "!!!Must be connected to adea.hum domain!!!"
        ...
        $global:SqlConnection = New-Object System.Data.SqlClient.SqlConnection # Create new instance of SQL Connection Object
        $global:SqlAdapter = New-Object System.Data.SqlClient.SqlDataAdapter # Instance of SQL Adapter Object
        $global:SqlCmd = New-Object System.Data.SqlClient.SqlCommand # Create new instance of SQL Command Object
        $global:SqlConnection.ConnectionString = "Server=CMWPDB; Database=CM_WP1; Integrated Security = True;" # SQL Connection String
    ...
    {
        param ($Query)
        $global:SqlCmd.CommandText = $Query # Assign the SQL Query string to the CommandText property of SqlCmd Object
		$global:SqlCmd.Connection = $SqlConnection # Pass out connection string to the Connection property of the SqlCmd Object
		$global:SqlAdapter.SelectCommand = $SqlCmd # Pass the constructed SqlCmd Object to the SQL Adapter Object
    }
