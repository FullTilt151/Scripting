...
$result = E:\packages\1E\1E_Free_Tools\WMIConfigPerms.v1.0.10.2\WMIConfigPerms.exe /N $namespace 
$sddl = $result[4]

([wmiclass]"Win32_SecurityDescriptorHelper").SDDLToBinarySD($sddl).BinarySD

Invoke-WmiMethod -Class Win32_SecurityDescriptorHelper -Name SDDLToWin32SD -ArgumentList $sddl | select Descriptor
