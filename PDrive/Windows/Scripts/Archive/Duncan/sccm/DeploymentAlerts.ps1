...
.EXAMPLE
   DeploymentAlerts.ps1 %sc  %sitesvr  %msgis01  %msgis02  %msgis03  %msgis04  %msgsys
   F:\scripts\DeploymentAlerts.cmd 
#>

#region Email Lists and Constants

$global:SMTPServer = "mailserver.local"
$global:SMTPSender = "no-reply@maildomain.local"
...
$alertList = @(
"sccmguru@maildomain.local",
"sccmmanager@maildomain.local"
)
...
$textAlertList = @(
"9995550001@vtext.com",
"9995551234@messaging.sprintpcs.com"
)
