...
Else {
    Do {
        ...
        If ($PackageInfo) {
            ...
            Else {
                ...
                "Created collection $PCollection in $FolderPath" | Out-File $Logfile -Append
            }
            ...
            Else {
                ...
                "Created collection $VCollection in $FolderPath" | Out-File $Logfile -Append
            }
    ...
    } Until ($PackageID -eq 0) or ($PackageID -eq $packageID)
}
