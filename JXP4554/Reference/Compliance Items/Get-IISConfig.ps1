## This is the script provided by Larry Glenn
            ...
            try {
                ...
                if ($processexecutablepath.ToLower().EndsWith("httpd.exe") -eq $true) {
                    if (Test-Path -Path $processexecutablepath) { 
                        ...
                        $webserverversion = $match.Groups[1].Value                      # Pull out: x.x.x
                    }
                    else {
        ...
        elseif ($process.CommandLine -match "tomcat") {
            ...
            try {
                ...
                if (Test-Path -Path $catalina_path) { 
                    ...
                    $webserverversion = "catalina.jar not found at: $opatch_path"
                    $webserverpatch = "catalina.jar not found at: $opatch_path"
                }
            }
            catch {}
