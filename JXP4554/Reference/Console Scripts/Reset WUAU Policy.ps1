...
try {
    Move-Item -Path "$env:windir\System32\GroupPolicy\Machine\Registry.pol" -Destination "$env:windir\System32\GroupPolicy\Machine\Registry.old"
}
...
Invoke-CMClient -Action UpdateScan