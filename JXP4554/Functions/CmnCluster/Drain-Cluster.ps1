...
(
    [Parameter(Mandatory = $true,
        HelpMessage = "Enter in drain, pullall")]
    [String]$ClusOp
)
...
if (-not(Test-Path -Path 'C:\Support')) {New-Item -Path 'C:\Support' -ItemType container}
...
Function Drain {
    ...
    $destnode = Get-clusternode | Select-Object -ExpandProperty Name
