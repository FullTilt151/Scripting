<#
.Synopsis
    Copies reports from SSRS server to directory
...
$ReportServerUri = "http://lousrswps09:8081/ReportServer/ReportService2005.asmx";
...
$fullFolderName = "\\louappwps873\cis\SCCM\Reports\" + $folderName;
