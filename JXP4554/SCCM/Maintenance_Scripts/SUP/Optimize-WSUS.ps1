...
$logFile = 'C:\Temp\Optimize-WSUS.log'
$sqlLog = 'C:\Temp\Optimize-WSUSIndex.log'
...
if ($PSBoundParameters['doReset']) {
    ...
    $params = [Array]"reset"
    New-CMNLogEntry -entry "Executing $cmd $params" -type 1 -logFile $logFile -component 'Optimize-WSUS/Reset'
    & $cmd $params
}
