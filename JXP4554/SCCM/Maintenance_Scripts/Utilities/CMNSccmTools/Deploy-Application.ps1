...
Try {
	...
	[string]$appVendor = 'ConfigMan-notes.com'
	[string]$appName = 'CMNSCCMTools'
	...
	[string]$appScriptAuthor = 'Jim Parris'
	##*===============================================
	## Variables: Install Titles (Only set here to override defaults set by the toolkit)
	[string]$installName = ''
	[string]$installTitle = ''
    [string]$ModuleFolder = "$env:windir\system32\WindowsPowerShell\v1.0\Modules\CMNSCCMTools"
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        {
            Remove-Folder -Path $ModuleFolder 
            Write-Log -Message 'Folder exists, removing'
        }
		...
		Copy-File -Path "$dirFiles\*.*" -Destination $ModuleFolder -Recurse
        Write-Log -Message "Files copied to $ModuleFolder"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        {
            Remove-Folder -Path $ModuleFolder
            Write-Log -Message 'Folder Removed'
        }	
        else
        {
            Write-Log -Message 'Folder not present'
        }	
