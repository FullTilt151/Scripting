function Get-CMNSoftwareUpdatePointSummary {
    param (
    ...
    $SoftwareUpdatePoints | ForEach-Object {
        ...
        if (Test-Connection -ComputerName $ServerName -Quiet -Count 3) {
            ...
            $WMI_Connection = Get-WmiObject -List "StdRegProv" -namespace root\default -ComputerName $ServerName -ErrorAction SilentlyContinue
            if ($WMI_Connection) {
