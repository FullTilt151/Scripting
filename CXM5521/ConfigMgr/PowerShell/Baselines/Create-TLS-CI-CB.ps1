...
$EnableList = @('TLS 1.0', 'TLS 1.1', 'TLS 1.2')
...
$EnabledListString = [string]::Join(', ', $EnableList)
$BL = New-CMBaseline -Name "Enforce $EnabledListString" -Description "Configures the machine to only allow $EnabledListString"
