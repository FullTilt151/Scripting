...
Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Google\Chrome\3rdparty\extensions\fklgmciohehgadlafhljjhgdojfjihhk\policy" -Name "adminMode"
Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Google\Chrome\3rdparty\extensions\fklgmciohehgadlafhljjhgdojfjihhk\policy" -Name "fetchURL"

#Now smoke the keys
Remove-Item -Path "HKLM:\SOFTWARE\Policies\Google\Chrome\3rdparty" -Recurse
Remove-Item -Path "HKLM:\SOFTWARE\Policies\Google\Chrome\ExtensionInstallForcelist" -Recurse
