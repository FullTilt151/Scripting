...
if (PSasAdmin){
    ...
    ''
    Write-Host "Recommended action: This test needs to be running with normail privileges" -ForegroundColor Yellow -BackgroundColor Black
    ''
    ''
...
Function NewFun{
        ...
        if ($AADDevice.count -ge 1){
            ...
            if (-not $AADDevice.AlternativeSecurityIds){
                Write-Host "The device has not registered yet, it is still in 'Pending' state." -ForegroundColor Red
                ''
                ...
                Write-Host "                       If the issue still persestant, check the possible courses on the article: http://www.microsoft.com/aadjerrors" -ForegroundColor Yellow
                ''
                ''
                Write-Host "Script completed successfully." -ForegroundColor Green -BackgroundColor Black
                exit
...
Function DJ++1{
        ...
        if ($DJ -ne "YES"){
            ...
            ''
            Write-Host "Recommended action: Run 'dsregcmd /join' command to perform hybrid Azure AD join procedure and re-run the script again, if the issue still persestant, check the possible courses on the article: http://www.microsoft.com/aadjerrors" -ForegroundColor Yellow
            ''
            ''
            Write-Host "Script completed successfully." -ForegroundColor Green -BackgroundColor Black
            exit
...
cls
'=========================================================='
Write-Host '          Device Registration Troubleshooter          ' -ForegroundColor Green 
'=========================================================='
''
