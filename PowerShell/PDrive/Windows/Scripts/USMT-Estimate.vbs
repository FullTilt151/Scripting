...
Sub Main
	...
	If g_WshShell.ExpandEnvironmentStrings("%ProgramFiles(x86)%") <> "" Then
		architecture = "amd64"
	End If
...
Sub RunScanState (ByVal subfolder, ByVal output, ByVal args)
	...
	commandLine = subfolder & "\scanstate C:\usmtestimate /l:%temp%\scanstate.log " & ScanStateOptions & " /p:""" & output & """ " & scanstateArgs
