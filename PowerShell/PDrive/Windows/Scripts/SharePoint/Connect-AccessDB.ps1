...
function Convert-AccessTypeCode ([string]$typeCode) {
	...
	$labelLookupHash = @{"Text"="202"; "Memo"="203"; "Date/Time"="7"; "Currency"="6"; "Yes/No"="11"; "OLE Object"="205"; "Byte"="17"; "Integer"="2"; "Long Integer"="3"; "Single"="4"; "Double"="5"}
	$codeLookupHash =  @{"202"="Text"; "203"="Memo"; "7"="Date/Time"; "6"="Currency"; "11"="Yes/No"; "205"="OLE Object"; "17"="Byte"; "2"="Integer"; "3"="Long Integer"; "4"="Single"; "5"="Double"}
...
# Connect-AccessDB "e:\reports\SoftwareCertPrioritization.accdb"
# Open-AccessRecordSet "select * from [Software Cert Prioritization]"
# Get-AccessRecordSetStructure
# Convert-AccessRecordSetToPSObject | Select-Object * | Format-Table -AutoSize
# Execute-AccessSQLStatement "UPDATE [Software Cert Prioritization] SET [Status] = 'In Progress' WHERE [CR#] = 60907"
