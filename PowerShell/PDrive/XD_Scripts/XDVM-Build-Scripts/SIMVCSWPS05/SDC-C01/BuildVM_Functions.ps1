...
Get-VMHost -Name $ESX_Host | Get-Datastore | %{
      if($_.FreeSpaceMB -gt ($freeGBTgt * 1KB) -and $_.Name -like "HUM-SDC-INTR-PROD-XEXDESKTOP-C01*" -and $_.Name -notlike "MGMT*" -and $_.Name -notlike "*storage-1" -and $_.Name -notlike "*250*" -and $_.FreeSpaceMB -gt $maxDsFree){
