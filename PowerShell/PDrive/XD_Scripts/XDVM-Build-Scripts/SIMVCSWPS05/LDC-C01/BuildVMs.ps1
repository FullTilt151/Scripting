...
$VMVcenter = 'simvcswps05.rsc.humad.com'
$XD_DDC = 'LOUXDCWPGX1S001.TS.HUMAD.COM'

##Note - Change the Cluster Array if there is less than 100 GB free on the one the script chooses
$Site_Cluster_LDC_Array = "HUM-LDC-INTR-PROD-XENDESKTOP-C01"
...
#$Site_Network_LDC = 'dvLDC_Xen_Net1-10.224.0.0'  
#$Site_Network_LDC = 'dvLDC_Xen_Net2-10.224.2.0'  
#$Site_Network_LDC = 'dvLDC_Xen_Net3-10.224.4.0'  
#$Site_Network_LDC = 'dvLDC_Xen_Net4-10.224.6.0'  
#$Site_Network_LDC = 'dvLDC_Xen_Net5-10.224.8.0'  
#$Site_Network_LDC = 'dvLDC_Xen_Net6-10.224.10.0' 
#$Site_Network_LDC = 'dvLDC_Xen_Net7-10.224.12.0' 
#$Site_Network_LDC = 'dvLDC_Xen_Net8-10.224.14.0' 
#$Site_Network_LDC = 'dvLDC_Xen_Net9-10.224.16.0' 
#$Site_Network_LDC = 'dvLDC_Xen_Net10-10.224.18.0'
$Site_Network_LDC = 'dvLDC_Xen_Net11-10.224.20.0'
#$Site_Network_LDC = 'dvLDC_Xen_Net12-10.224.22.0'
#$Site_Network_LDC = 'dvLDC_Xen_Net13-10.224.24.0'
#$Site_Network_LDC = 'dvLDC_Xen_Net14-10.224.26.0'
#$Site_Network_LDC = 'dvLDC_Xen_Net15-10.224.28.0'
#$Site_Network_LDC = 'dvLDC_Xen_Net16-10.224.30.0'
...
if ($VMName -ne $NULL) {	
	...
	$XD_Machine = New-BrokerMachine -AdminAddress $XD_DDC -MachineName $FullVM -CatalogUid $Catalog_UID -HostedMachineId $VMHostedID -HypervisorConnectionUid 3
}
}