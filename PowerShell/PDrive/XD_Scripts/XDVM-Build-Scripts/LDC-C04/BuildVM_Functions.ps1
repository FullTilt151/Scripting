...
Get-VMHost -Name $ESX_Host | Get-Datastore | %{
      if($_.FreeSpaceMB -gt ($freeGBTgt * 1KB) -and $_.Name -like "HUM-LDC-INTR-PROD-XEN-C04*" -and $_.Name -notlike "MGMT*" -and $_.Name -notlike "*storage-1" -and $_.Name -notlike "*250*" -and $_.FreeSpaceMB -gt $maxDsFree){
