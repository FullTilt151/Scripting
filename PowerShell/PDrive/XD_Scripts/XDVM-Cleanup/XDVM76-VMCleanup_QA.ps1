...
Connect-VIServer simvcswps05.rsc.humad.com | Out-Null     #Create the connection to the VCenter.

#Set the Delivery Group.

[int]$MenuChoice = 0
while ( $MenuChoice -lt 1 -or $MenuChoice -gt 8 ){
  Write-Output ""
  Write-Output "Please choose the VM Type that will be removed (1-8)" 
  Write-Output ""
  Write-Output "1. WTSA"
  Write-Output "2. WTSB"
  Write-Output "3. WTSC"
...
$controller="LOUXDCWAGX1S001.TS.HUMAD.COM"   #Controller managing the VMs to be checked.
