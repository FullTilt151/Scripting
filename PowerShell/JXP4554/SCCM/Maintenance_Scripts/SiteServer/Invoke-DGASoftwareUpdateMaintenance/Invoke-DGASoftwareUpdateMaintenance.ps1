...
.LINK
    ...
    $deployedUpdates = Get-CimInstance -Namespace root\sms/site_MT1 -query "Select * from SMS_SoftwareUpdate" | Where-Object {$_.isDeployed -eq $true}
#>
...
#Generate the component used for logging based on the script name.
    ...
    If ($DeclineByTitle) {
        ...
        ForEach ($Update in $Updates) {
            ...
            ForEach ($SearchString In $DeclineByTitle) {
                ...
                If ($Update.Title -ilike $SearchString) {
