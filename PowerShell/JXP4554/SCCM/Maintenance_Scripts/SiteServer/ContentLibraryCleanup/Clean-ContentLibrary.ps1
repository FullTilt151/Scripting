Function Clean-CMNContentLibrary {
    <#
    .SYNOPSIS
    ...
    begin {
        ...
        $NewLogEntry = @{
            LogFile    = $logFile;
            Component  = 'Clean-CMNContentLibrary';
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess($sccmConnectionInfo.SiteCode)) {
            $packages = Get-CimInstance -ClassName SMS_Packages
        }
    }
