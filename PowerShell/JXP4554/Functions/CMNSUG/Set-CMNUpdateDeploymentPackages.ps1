...
Begin 
{
    ...
    try 
	{
		...
		$DataSourceWMI = $(Get-CimInstance -ClassName SMS_SiteSystemSummarizer -Filter "Role = 'SMS SQL SERVER' and SiteCode = '$SiteCode' and ObjectType = 1" @WMIQueryParameters).SiteObject
