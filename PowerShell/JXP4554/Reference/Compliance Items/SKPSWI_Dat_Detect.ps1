...
$Exists = $Exists -bor (Test-Path $FileName)
if ($Exists){
    Write-Host $true
    }
else{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU9M8bJe2GIkIsgNok9wcB0vbQ
# lUKggg+hMIIHdTCCBV2gAwIBAgIKVJ0IygABAAAFhzANBgkqhkiG9w0BAQUFADBE
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUK5J2JvLxnxGB
# xjMWml7Dv/rkj40wDQYJKoZIhvcNAQEBBQAEggEANlmfm6IWaxp6tIjYh02276md
# 8mQaNqYLmJSPp4gbG26MQXBPReDhLHOvFsXN2gd5D44jRnKSBCxY+QxB3WkEPMU9
# u7QBGRM17ODQ6ie/aEiND5XyiLvMyiHDgGtrPpS5S2Jz0TrSTU3u6/zgrrur5aMB
# CgZctCKfYw/yVglI6A7+IrV7BcZLLZnLz+LVkpO/ECk8Mh4zJB9Fcf5ARvNrZYIa
# cjhcBLnSxq6kWXxSKkZLAg/ctbWWj5pAUtTtbdCcFZfEYDEiv8CPBQ/nsWFTbSCY
# 6DXlCxeVYkBkKK0yE53gyDn3PETArlGhMPFHLr1CQ4mkoiKNj8PKN9bHbVqRuA==
