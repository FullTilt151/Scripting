param(
    ...
    [parameter(Mandatory = $true, HelpMessage = "Enter a valid collection ID:")]
    [string]$CollectionID
)
#Prompt for site, MT1, WQ1, SQ1, WP1
$CollectionID = Read-Host 'Enter Collection ID'
$inputfile = Read-Host 'Enter file locatio, full path'
$Server = 'LOUAPPWPS1658.rsc.humad.com'
<#$Server = switch ( $Site ) {
