...
Try {
	...
	[string]$appScriptDate = '03/12/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'xyz123' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt # replace 'xyz123' with the app you're installing.  Weird bug that requires this or the script will crash.
