...
Try {
	...
	[string]$appVendor = '1E'
	[string]$appName = 'Nomad Branch Admin Tools'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'Microsoft.ConfigurationManagement' -Silent # replace 'xyz123' with the app you're installing.  Weird bug that requires this or the script will crash.
		...
		Execute-MSI -Action 'Install' -Path 'NomadBranchAdminUIExt.msi' -Parameters '/QN'
		...
		Execute-MSI -Action 'patch' -path "Q20983-nomadbranchadminuiext.v7.0.100.77.msp" 
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action 'Uninstall' -Path '{440EF4FB-EA18-44C0-815F-2CA3B1FD316E}'
